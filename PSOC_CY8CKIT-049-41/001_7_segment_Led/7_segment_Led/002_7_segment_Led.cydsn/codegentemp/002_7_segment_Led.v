// ======================================================================
// 002_7_segment_Led.v generated from TopDesign.cysch
// 03/03/2020 at 12:59
...
module top ;
	...
	wire [0:0] tmpOE__IN_Pin_net;
	wire [0:0] tmpFB_0__IN_Pin_net;
	wire [0:0] tmpIO_0__IN_Pin_net;
	electrical [0:0] tmpSIOVREF__IN_Pin_net;
	...
	cy_psoc3_pins_v1_10
		...
		IN_Pin
		 (.oe(tmpOE__IN_Pin_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__IN_Pin_net[0:0]}),
		  .io({tmpIO_0__IN_Pin_net[0:0]}),
		  .siovref(tmpSIOVREF__IN_Pin_net),
		  .interrupt({Net_11}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__IN_Pin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
