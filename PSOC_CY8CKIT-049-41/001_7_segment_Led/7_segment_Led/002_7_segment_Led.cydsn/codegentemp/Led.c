...
#include "Led.h"
...
#if defined(Led__PC)
    #define Led_SetP4PinDriveMode(shift, mode)  \
    do { \
        Led_PC =   (Led_PC & \
                                (uint32)(~(uint32)(Led_DRIVE_MODE_IND_MASK << \
                                (Led_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << \
                                (Led_DRIVE_MODE_BITS * (shift))); \
    } while (0)
#else
        ...
        #define Led_SetP4PinDriveMode(shift, mode)  \
        do { \
            Led_USBIO_CTRL_REG = (Led_USBIO_CTRL_REG & \
                                    (uint32)(~(uint32)(Led_DRIVE_MODE_IND_MASK << \
                                    (Led_DRIVE_MODE_BITS * (shift))))) | \
                                    (uint32)((uint32)(mode) << \
                                    (Led_DRIVE_MODE_BITS * (shift))); \
    ...
    *******************************************************************************/
    ...
    {
		Led_SetP4PinDriveMode(Led__0__SHIFT, mode);
		Led_SetP4PinDriveMode(Led__1__SHIFT, mode);
		Led_SetP4PinDriveMode(Led__2__SHIFT, mode);
		Led_SetP4PinDriveMode(Led__3__SHIFT, mode);
		Led_SetP4PinDriveMode(Led__4__SHIFT, mode);
		Led_SetP4PinDriveMode(Led__5__SHIFT, mode);
		Led_SetP4PinDriveMode(Led__6__SHIFT, mode);
		Led_SetP4PinDriveMode(Led__7__SHIFT, mode);
    }
#endif
...
void Led_SetInterruptMode(uint16 position, uint16 mode)
{
    ...
    intrCfg =  Led_INTCFG & (uint32)(~(uint32)position);
    Led_INTCFG = intrCfg | ((uint32)position & (uint32)mode);
}
