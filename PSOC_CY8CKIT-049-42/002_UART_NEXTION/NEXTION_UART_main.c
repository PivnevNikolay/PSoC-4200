...
#define LED_OFF 0u
//--------------------------------------------------------------------------------------------------------------//
volatile uint16_t rec_array[9]={0u,0u,0u,0u,0u,0u,0u,0u,0u};//массив куда принемаем данные которые пришли с UART
...
int main(void)
{
    ...
    for(;;)
    {
        ...
        как только счётчик приёма привысит значение 9 необходимо очистить все буферы 
